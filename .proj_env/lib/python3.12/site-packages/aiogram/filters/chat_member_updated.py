...
class _MemberStatusGroupMarker:
    ...
    def __rshift__(
        ...
        if isinstance(other, _MemberStatusMarker):
            return _MemberStatusTransition(
                old=self, new=_MemberStatusGroupMarker(other)
            )
        if isinstance(other, _MemberStatusGroupMarker):
    ...
    def __lshift__(
        ...
        if isinstance(other, _MemberStatusMarker):
            return _MemberStatusTransition(
                old=_MemberStatusGroupMarker(other), new=self
            )
        if isinstance(other, _MemberStatusGroupMarker):
...
class _MemberStatusTransition:
    ...
    def __init__(
        self, *, old: _MemberStatusGroupMarker, new: _MemberStatusGroupMarker
    ) -> None:
        self.old = old
        self.new = new
...
class ChatMemberUpdatedFilter(Filter):
    ...
    async def __call__(
        self, member_updated: ChatMemberUpdated
    ) -> bool | dict[str, Any]:
