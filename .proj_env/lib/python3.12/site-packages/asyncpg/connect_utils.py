    ...
    try:
        ...
        async def _close_candidates(conns, chosen):
            await asyncio.gather(
                *(c.close() for c in conns if c is not chosen), return_exceptions=True
            )
